...
ARG NEXT_PUBLIC_OUTAGE_MESSAGE
ARG NEXT_PUBLIC_FEATURE_ANNOUNCEMENT
...
ENV NEXT_PUBLIC_OUTAGE_MESSAGE=${NEXT_PUBLIC_OUTAGE_MESSAGE}
ENV NEXT_PUBLIC_FEATURE_ANNOUNCEMENT=${NEXT_PUBLIC_FEATURE_ANNOUNCEMENT}
