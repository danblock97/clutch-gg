					...
					<div className="md:col-span-3">
						...
						<ul className="space-y-2">
							...
							<li>
								<a
									id="myCustomTrigger"
									className="text-sm hover:text-[--primary] transition-colors cursor-pointer inline-flex items-center"
								>
			...
			<div className="bg-[--card-bg-secondary] border-t border-[--card-border] py-4">
				<div className="container max-w-6xl mx-auto px-4 text-center text-xs">
					...
					<p className="mt-2 text-[--text-secondary] max-w-2xl mx-auto">
						ClutchGG.LOL is not endorsed by Riot Games and does not reflect the views or opinions of
