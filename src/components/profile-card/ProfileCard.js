    ...
    <div ref={wrapRef} className={`pc-card-wrapper ${className}`.trim()} style={cardStyle}>
      <section ref={cardRef} className="pc-card">
        ...
        <div className="pc-inside">
          ...
          {!disableGlow && <div className="pc-glare" />}
          {showAvatar && (
          ...
          <div className="pc-content">
            {showUserInfo && (
              <div className="pc-user-info">
                ...
                <button className="pc-contact-btn" onClick={handleContactClick} style={{ pointerEvents: "auto" }} type="button">
                  {contactText}
                </button>
              </div>
            )}
          ...
          {(topOverlay || bottomOverlay) && (
            <div className="pc-overlay">
              {topOverlay && <div className="pc-top">{topOverlay}</div>}
              {bottomOverlay && <div className="pc-bottom">{bottomOverlay}</div>}
            </div>
          )}
        </div>
      </section>
