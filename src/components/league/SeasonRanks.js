		...
		return (
			<div className="overflow-hidden bg-white/5 rounded-xl">
				<div className="flex items-center justify-between p-4 border-b border-[--card-border] bg-black/20">
					...
					<button
						className="h-8 w-8 flex items-center justify-center rounded-lg bg-white/5 text-[--text-secondary] cursor-default"
				...
				<div className="p-4">
					<div className="flex flex-col items-center justify-center py-6 min-h-[120px] bg-black/10 rounded-lg border border-[--card-border]">
						<div className="loading-spinner"></div>
						<p className="text-[--text-secondary] mt-4 text-sm">Loading rank history...</p>
					</div>
				</div>
			</div>
		);
	...
	if (error && rankHistory.length === 0) {
		return (
			<div className="overflow-hidden bg-white/5 rounded-xl">
				...
				<div className="p-4">
					<div className="rounded-lg border border-[--card-border] bg-black/10 px-3 py-4 text-sm text-[--error]">
						Error: {error}
					</div>
				</div>
			</div>
	...
	if (!isLoading && !error && rankHistory.length === 0) {
		return (
			<div className="overflow-hidden bg-white/5 rounded-xl">
				...
				<div className="p-4">
					<div className="rounded-lg border border-[--card-border] bg-black/10 px-3 py-4 text-sm text-[--text-secondary]">
