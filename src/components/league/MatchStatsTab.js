        ...
        >
          <div className="px-4 py-2 border-b border-[--card-border] flex items-center justify-between">
            <div className="flex items-center">
              <FaCrown
                className={`mr-2 ${place === 1 ? "text-yellow-500" : "text-[--text-secondary]"}`}
              />
  ...
  return (
    <div className="p-4">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="card-highlight p-4 flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-[--text-secondary]">
              {new Date(match.info.gameCreation).toLocaleString()} • Duration:{" "}
          ...
          <div className="text-right">
            <p className="text-sm">
              ...
              <span className="text-[--text-secondary] font-mono">
                {match.metadata.matchId.slice(-8)}
              </span>
            </p>
          </div>
        </div>
        ...
        {/* Team 1 (Blue) */}
        <div
          className={`card ${t1Winner ? "border-l-4 border-green-500" : "border-l-4 border-red-500"}`}
        >
        ...
        {/* Team 2 (Red) */}
        <div
          className={`card ${t2Winner ? "border-l-4 border-green-500" : "border-l-4 border-red-500"}`}
        >
          <div className="flex justify-between items-center p-4 border-b border-[--card-border]">
            <div className="flex items-center">
...
function Participant({ p, puuid, r, getA, getPerk, arena = false }) {
  ...
  return (
    ...
    >
      <div
        className={`flex items-center p-3 hover:bg-[--card-bg-secondary] transition-colors duration-150 ${isCurrentPlayer ? "bg-[--primary]/5" : ""}`}
      >
        <div className="flex-1 md:w-1/3 flex items-center">
          ...
          <div className="overflow-hidden">
            <div
              className={`font-medium truncate ${isCurrentPlayer ? "text-[--primary]" : ""}`}
            >
              {p.riotIdGameName}
