      ...
      <div className="space-y-12">
        ...
        <section>
          <div className="relative group">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-red-500/20 to-pink-500/20 rounded-2xl blur opacity-30 group-hover:opacity-50 transition duration-1000"></div>
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-sm text-[--text-secondary] hidden sm:inline-block">
              Publicly tracked issues
            </span>
          </div>
          <div className="bg-black/20 rounded-2xl border border-white/5 p-1">
            {/* Using PublicIssuesBoard directly to show bugs on the same page */}
            <PublicIssuesBoard type="bug" />
          </div>
        </section>
